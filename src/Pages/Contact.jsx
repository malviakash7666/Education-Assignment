...
const Contact = () => {
  ...
  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
    ...
    <form action="https://formspree.io/f/xovpopoa" method='POST' classNameName="space-y-4 rounded-lg border border-gray-300 bg-gray-100 p-6">
      <div>
        <label className="block text-sm font-medium text-gray-900" for="name">Name</label>

        <input className="mt-1 w-full border px-5 h-10 rounded-lg border-gray-300 focus:border-indigo-500 focus:outline-none" id="name" name='userName' type="text" placeholder="Your name" />
      </div>

      <div>
        <label className="block text-sm font-medium text-gray-900" for="email">Email</label>

        <input className="border px-5 h-10 mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:outline-none" id="email" type="email" name='email' placeholder="Your email" />
      </div>

      <div>
        <label className="block text-sm font-medium text-gray-900" for="message">Message</label>

        <textarea className="mt-1 border p-5  w-full resize-none rounded-lg border-gray-300 focus:border-indigo-500 focus:outline-none" id="message" rows="4" placeholder="Your message" name='message'></textarea>
      </div>
